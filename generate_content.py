...
{{
    ...
    "voiceover_script": "Short natural reel narration that says the hook and all 4 points clearly in under 18 seconds",
...
- `voiceover_script` should sound like a viral short narrator.
